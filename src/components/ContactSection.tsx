    ...
    <section className="section-padding bg-primary relative overflow-hidden">
      ...
      <div className="container-width relative z-10">
        ...
        >
          ...
          >
            <Phone className="w-6 h-6 sm:w-8 sm:h-8 flex-shrink-0" aria-hidden="true" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center text-primary-foreground/80 text-sm sm:text-base">
            ...
            <div className="hidden sm:block w-1 h-1 rounded-full bg-primary-foreground/40" aria-hidden="true" />
